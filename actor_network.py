...
class ActorNetwork:
	...
	def __init__(self,sess,state_dim,action_dim):
		...
		print("create_network(state_dim,action_dim)")
	...
	def create_network(self,state_dim,action_dim):
		...
		action_output = tf.nn.sigmoid(tf.matmul(layer2,W3) + b3, name ='sigmoid')
	...
	def create_target_network(self,state_dim,action_dim,net):
		...
		action_output = tf.nn.sigmoid(tf.matmul(layer2,target_net[4]) + target_net[5], name ='sigmoid')
